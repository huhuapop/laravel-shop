...
{{--                            <select-district @change="onDistrictChanged" inline-template>--}}
                            <select-district v-bind:init-value="{{ json_encode([old('province', $address->province), old('city', $address->city), old('district', $address->district)]) }}" @change="onDistrictChanged" inline-template>
